...
python -m gridsteer.step1.Old.LineFindingImplementation.optimize_phi "/qfs/projects/bioprep/data/automation/new_grid_center_db.2/" 99 --verbose
"""
...
from gridsteer.step1.Old.LineFindingImplementation import  optimize_phi_transient
